/**
 * Credits to this utils go 100% to:
 * Author: BavFalcon9
 * Source: https://deno.land/x/Nitro@v0.1.2-dev/src/utils/discord/SimpleEmbed.ts
 * Note: I renamed this to 'MessageEmbed' because that's what I'm normally accustomed to type
 */
